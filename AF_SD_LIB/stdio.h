...
extern _ARMABI int fcloseA(FILE * /*stream*/) __attribute__((__nonnull__(1)));
   /*
...
extern _ARMABI int fflush(FILE * /*stream*/);
    ...
    */
extern _ARMABI FILE *fopenA(const char * __restrict /*filename*/,
...
extern _ARMABI size_t fwriteA(const void * __restrict /*ptr*/,
                    size_t /*size*/, size_t /*nmemb*/, FILE * __restrict /*stream*/) __attribute__((__nonnull__(1,4)));
   /*
