...
static void LCD_Configuration(void)
{
	...
	LPC_GPIO2->FIODIR   |= 0x00002F00;
	LPC_GPIO2->FIOSET    = 0x00000F00;
}
...
void LCD_Initializtion(void)
{
	...
	LPC_GPIO0->FIODIR |= (0xFF<<15);
	LPC_GPIO0->FIODIR |= (0xFF<<4);
  LPC_GPIO2->FIODIR |= PIN_CS | PIN_RS | PIN_WR | PIN_RD | PIN_RST;					
  LPC_GPIO2->FIOSET = PIN_CS | PIN_RS | PIN_WR | PIN_RD | PIN_RST;
	
	LPC_GPIO2->FIOCLR |= PIN_RST;
  delay_ms(50);                            				 	/* Delay 50 ms             		*/
	LPC_GPIO2->FIOSET |= PIN_RST;
	LCD_Configuration();
	delay_ms(100);
